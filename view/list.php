    ...
    <div class="col col-12 p-2 todo-item" todo-id="<?php echo $items[$i]['item_id']; ?>">
      <div class="input-group">
        ...
        <div class="input-group-append">
          ...
          <button class="btn btn-outline-secondary bg-success text-white" type="button" id="button-addon2" >
            <a style="color: white" href="modules/update.php? updateid='.$id.'">Edit</a>
          </button>
